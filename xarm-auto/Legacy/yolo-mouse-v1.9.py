...
def draw_inspection_crosshair(frame, x, y, offset_error=CAMERA_OFFSET_ERROR):
    ...
    # Convert mm error to pixels (approximate scaling)
...
def main():
    ...
    cv2.moveWindow(window_detect, 
                  window_config.get("detection_pos_x", 1100), 
    ...
    if cam_inspect:
        ...
        cv2.moveWindow(window_inspect, 
                      window_config.get("inspection_pos_x", 100), 
    ...
    try:
        while True:
            ...
            # cv2.putText(
            #     annotated_frame,
            #     "L-Click:Move | M-Click:Pick | R-Click:Place | T:Inspect | Q:Quit",
            #     (10, frame_detect.shape[0] - 10),
            #     cv2.FONT_HERSHEY_SIMPLEX,
            #     0.5,
            #     (0, 0, 0),
            #     2,
