...
class XArmController:
    ...
    def __init__(self, config_path="config.json"):
        ...
        self.calibration_position = {
            "x": calib_config.get("x", -100),
            "y": calib_config.get("y", 215.9),
            "z": calib_config.get("z", 174),
            "roll": calib_config.get("roll", 180),
            "pitch": calib_config.get("pitch", 0),
            "yaw": calib_config.get("yaw", 0)
        }
    ...
    def initialize_robot(self):
        ...
        try:
            ...
            tcp_speed = self.config.get("tcp_speed", 200)
    ...
    def go_to_calibration_position(self):
        ...
        try:
            ...
            if code == 0:
                ...
                print("[Calibration] Ready for camera calibration")
                print("="*60 + "\n")
                return True
            else:
